...
## 🚀 Cápsula do Tempo 
<p> Projeto realizado na Next Level Week #12 da Rocketseat, funciona como uma linha do tempo, ou seja, é possível cadastrar memórias adicionando uma legenda e optando por torná-la público ou privado, o cadastro pode ser feito a partir de uma conta no Git Hub. Existe a versão para web e a versão mobile.</p>
