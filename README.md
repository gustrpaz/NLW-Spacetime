<div style="width:100%; height: 200px; display: flex; align-items: center;;justify-content: space-between;">
  <h1> NLW-Spacetime Rocketseat Trilha Ignite</h1>
</div>
...
## 🚀 Cápsula do Tempo 
<p> Projeto realizado na Next Level Week #12 da Rocketseat, funciona como uma linha do tempo, ou seja, é possível cadastrar memórias adicionando uma legenda e optando por torná-lo público ou privado, o cadastro pode ser feito a partir de uma conta no Git Hub. Existe a versão para web e a versão mobile.</p>
